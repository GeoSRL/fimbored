  <h4 class="hide_all">Hide</h4>
	...
	<div class="tab_container">
		...
		<form method="post" action="">
			...
			<input type="submit" class="main_btn search_btn clearb right" value="Send" name="addWeap">
		</form>	
			</div>
		...
		<form method="post" action="">
			...
			<div class="search_txt">
				Price (InTime): </div> 
					<input type="text" value="0000:000:00:00:00" class="search_box contact right" name="price">
			<input type="submit" class="main_btn search_btn clearb right" value="Send" name="addItem">
		</form>	
			</div>
		...
		<form method="post" action="">
			...
			<div class="search_txt">
				Reqs: </div>
					<input type="text" value="<? echo $form->reqs; ?>" class="search_box contact right" name="reqs">
			<input type="submit" class="main_btn search_btn clearb right" value="Send" name="addJob">
		</form>	
			</div>
